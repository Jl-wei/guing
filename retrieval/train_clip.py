...
# Modified from https://github.com/huggingface/transformers/blob/main/examples/pytorch/contrastive-image-text/run_clip.py
...
class Transform(torch.nn.Module):
    def __init__(self, image_size, mean, std):
        ...
        self.transforms = torch.nn.Sequential(
            Resize(size=[image_size, image_size], interpolation=F.InterpolationMode.BICUBIC, antialias=True),
...
def main():
    ...
    image_processor.size = {"shortest_edge": [224,224]}
